...
function TopBar() {
  return (
    ...
    <div className="d-flex justify-content-md-start align-items-center d-lg-none">
        <img className='rounded-circle' src="/img/cat-2.jpg" alt="" width={50} />
    ...
    <div className="d-inline-flex justify-content-center text-center align-items-center">
        <div className="btn-group mr-0 mr-md-3  ">
            <button type="button" className="btn btn-sm btn-primary w dropdown-toggle" data-toggle="dropdown">My Account</button>
        ...
        <div className='d-md-none d-none d-lg-block'>
            ...
            <a href='tel:/+92 3332830600' className="m-0 text-dark fw-bold text-decoration-none">+92 3332830600</a>
        </div>
    </div>
</div>
